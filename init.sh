...
cat cmd/_app-name_/main.go | sed "s@package-name@${PACKAGE_NAME}@g" > temp && rm -rf cmd/_app-name_/main.go && mv temp cmd/_app-name_/main.go

cat cmd/_app-name_/main.go | sed "s@_app-name_@${APP_NAME}@g" > temp && rm -rf cmd/_app-name_/main.go && mv temp cmd/_app-name_/main.go

cat cmd/_app-name_/command/default.go | sed "s@package-name@${PACKAGE_NAME}@g" > temp && rm -rf cmd/_app-name_/command/default.go && mv temp cmd/_app-name_/command/default.go
